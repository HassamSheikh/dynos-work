...
```text
python3 "{{HOOKS_PATH}}/ctl.py" validate-contract --skill start --task-dir .dynos/task-{id} --direction both --strict
python3 "{{HOOKS_PATH}}/ctl.py" validate-contract --skill execute --task-dir .dynos/task-{id} --direction both --strict
python3 "{{HOOKS_PATH}}/ctl.py" validate-contract --skill audit --task-dir .dynos/task-{id} --direction both --strict
```

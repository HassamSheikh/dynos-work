...
1. Find the most recent active task in `.dynos/` (manifest.json with stage not DONE/FAILED). If available in this repo, use `python3 "{{HOOKS_PATH}}/ctl.py" active-task`.

...
Maintain the `## Agent Routing` section in `project_rules.md`, but treat `.dynos/learned-agents/registry.json` plus `hooks/dynoroute.py` as the live routing source of truth.

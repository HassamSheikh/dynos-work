...
def test_plan_routing_writer_deleted(tmp_path: Path):
    """Task-007 A-001: receipt_plan_routing is DELETED — the silently
    vacuous gate + orphan writer is fully removed. Asserting deletion
    guards against quiet re-addition."""
